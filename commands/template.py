...
help_text = [
    ...
    [
        (
            "title",
            "These extra variables are available to **💳 Gold** or **💎Sapphire** patrons only:\n"
            "Become a patron here: https://patreon.com/pixaal",
        ),
        (" ·  `@@nato@@` - 💳 only", "Use the NATO Phonetic Alphabet (Alpha, Bravo, Charlie...) as the channel number."),
        (
