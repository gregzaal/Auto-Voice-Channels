...
async def admin_command(cmd, ctx):
    ...
    if cmd == 'stats':
        ...
        up_time_tuple = client.up_time()    # Days, Hours, Minutes, Seconds returned
        ...
        await r.edit(content=(
            ...
            "**Timings:** {timings}".format(
                ...
                commit=LAST_COMMIT,
                lines=lines_of_code,
                days=up_time_tuple[0],
                hours=up_time_tuple[1],
                minutes=up_time_tuple[2],
                seconds=up_time_tuple[3],
